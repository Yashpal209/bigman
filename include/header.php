                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav mx-auto fw-bold">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="servicesDropdown">
                                        <li class="dropdown-submenu">
                                            <a class="dropdown-item dropdown-toggle" href="product.php">Door</a>
                                        ...
                                        <li><a class="dropdown-item" href="product.php">WPC Frams</a></li>
                                        <li><a class="dropdown-item" href="product.php">WPC Sheets</a></li>
                                        <li><a class="dropdown-item" href="product.php">Luvar</a></li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="servicesDropdown">
                                        <li><a class="dropdown-item" href="product.php">Door Lock</a></li>
                                        <li><a class="dropdown-item" href="product.php">Hardware</a></li>
                                    </ul>
                                </li>
        ...
        <ul class="list-group">
            ...
            <li class="list-group-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="productsDropdown">
                    <li class="dropdown">
                        <a class="dropdown-item dropdown-toggle" href="#" id="submenuDoor">Door</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="product.php?type=wooden">Wooden Doors</a></li>
                            <li><a class="dropdown-item" href="product.php?type=glass">Glass Doors</a></li>
                            <li><a class="dropdown-item" href="product.php?type=metal">Metal Doors</a></li>

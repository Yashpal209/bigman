        ...
        <section class=" about bg-light py-5">
            <div class="container text-center ">
                ...
                <div class="row d-flex justify-contant-center align-items-center pt-3 ">
                    <div class="col-md-6 ">
                        <img src="img/Bigmanply.png" class="img-fluid rounded" alt="">
                    </div>
            ...
            <div class="container text-center">
                ...
                <div class="row text-center py-3">
                    <div class="col-md-3 col-6">
                        <img src="img/user.png" width="70%" alt="">
                        <h5 class="pt-2"> Director</h5>
                        <p> Name </p>
                    </div>
                    <div class="col-md-3 col-6">
                        <img src="img/user.png" width="70%" alt="">
                        <h5 class="pt-2">Sub Director</h5>
                        <p> Name </p>
                    </div>
                    <div class="col-md-3 col-6">
                        <img src="img/user.png" width="70%" alt="">
                        <h5 class="pt-2"> Chairman</h5>
                        <p> Name </p>
                    </div>
                    <div class="col-md-3 col-6">
                        <img src="img/user.png" width="70%" alt="">
                        <h5 class="pt-2"> CTO</h5>
                        <p> Name </p>
                    </div>
                </div>
